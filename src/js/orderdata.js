...
form.addEventListener("submit", (e) => {
  ...
  let url = `https://api.whatsapp.com/send?phone=6289509941906&text=*Halo%20Admin,%20Saya%20Mau%20TopUp%20Paket%20Data*.%0ADetail%20Pesanan%20%3A%0ANomor%20Tujuan%20%3A%20${nomor}%0AJumlah%20Pembelian%20%3A%20${inputNominal}%0APembayaran%20%3A%20${paymentMethod}%0A%0AOrder Via Web KazuhaID`;
  window.open(url);
});
